    ...
    <ul class="nav bg-white shoploc pb-0">
        <li class="nav-item">
            <a class="nav-link pt-2 mt-1" onClick="window.history.back()">
                <svg id="Layer" enable-background="new 0 0 64 64" height="25pt" float="left" fill="#999" viewBox="0 0 64 64" width="25pt" xmlns="http://www.w3.org/2000/svg">
                    <path d="m54 30h-39.892l15.272-14.552c.799-.762.83-2.028.068-2.828-.762-.798-2.027-.831-2.828-.068l-17.445 16.625c-.758.758-1.175 1.761-1.175 2.823s.417 2.063 1.21 2.858l17.41 16.59c.387.369.884.552 1.38.552.528 0 1.055-.208 1.448-.62.762-.8.731-2.065-.068-2.828l-15.341-14.552h39.961c1.104 0 2-.896 2-2s-.896-2-2-2z" fill="#012e52" />
                </svg>
            </a>
        </li>
        ...
        <li class="nav-item ml-3">
            <a class="nav-link px-1 pt-3 " href="search_product">
                <svg version="1.1" id="Capa_1" width="20pt" height="20pt" fill="#999" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
                    <g>
                        <g>
        ...
        <li class="nav-item ml-2 ">
            <a href="cart" class="nav-link ml-4 pt-3 px-1">
                <svg viewBox="0 -36 512.001 512" width="25pt" height="25pt" fill="#ff7b00" xmlns="http://www.w3.org/2000/svg">
...
<div class="container-fluid pro_list p-3">
    ...
    if (isset($_GET['store_id'])) {
        ...
        $get_cat = "select * from products where store_id='$store_id' and product_visibility='Y' order by (100-((price_display/product_price)*100)) asc";
    ...
    ?>
                ...
                <div class="row bg-white mt-1 py-2" id="<?php echo $pro_id; ?>">
                    <div class="col-4">
                        <span class="notify-badge <?php if (($price_display - $pro_price) > 0) {
                                                        echo "show";
                                                    } else {
                                                        echo "d-none";
                                                    } ?> mr-4">
                            <h5 class="pro_dis_batch mb-0"><?php echo $discount_percent; ?> % OFF</h5>
                        </span>
                    ...
                    <div class="col-8">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="row">
                                    <!-- <div class="col-4 px-0 <?php //if($price_display>0){echo "show";}else{echo "d-none";}
                                                                ?> "><h5 class="pro_dis_price">₹ <?php //echo $price_display; 
                                                                                                    ?> </h5></div> -->
                                    <div class="col-8 pr-0">
                                        <h6 class="pro_dis_price mb-0 text-dark <?php if ($price_display > 0) {
                                                                                    echo "show";
                                                                                } else {
                                                                                    echo "d-none";
                                                                                } ?>"> MRP ₹ <?php echo $price_display; ?> </h6>
