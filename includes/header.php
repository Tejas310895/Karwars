...
<head>
    ...
    <!-- date -->
    <!-- styles -->
    <link rel="stylesheet" href="styles/style.css?version=33">
    <!-- styles -->
    ...
    <script>
        ...
        fbq('init', '563060964584581');
        fbq('track', 'PageView');
    </script>
    <noscript><img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=563060964584581&ev=PageView&noscript=1" /></noscript>
    <!-- End Facebook Pixel Code -->
</head>

<body>
    <div id="fade-wrapper" class="text-center pt-5">
        <svg height="100pt" viewBox="0 0 512.00057 512" width="100pt" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
