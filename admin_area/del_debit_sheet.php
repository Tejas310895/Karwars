...
<div class="row">
           ...
           <div class="col-lg-6 col-md-6">
            <a href="index.php?del_raise_debit" class="btn btn-success pull-right">Raise Debit</a>
           </div>
       </div>
<div class="row">
<div class="col-lg-12 col-md-12">
    ...
    <tbody>
        <?php 
            ...
            $get_del_debits = "select * from del_debits";
            $run_del_debits = mysqli_query($con,$get_del_debits);
            $counter = 0;
            while($row_del_debits = mysqli_fetch_array($run_del_debits)){

            $delivery_partner_id = $row_del_debits['delivery_partner_id'];
            $del_debit_amt = $row_del_debits['del_debit_amt'];
            $del_debit_comment = $row_del_debits['del_debit_comment'];
            $updated_date = $row_del_debits['updated_date'];
        ...
        <tr>
            ...
            <td><?php echo $del_debit_amt; ?></td>
            <td><?php echo $del_debit_comment; ?></td>
        </tr>
        <?php } ?>
    <?php } ?>
    </tbody>
