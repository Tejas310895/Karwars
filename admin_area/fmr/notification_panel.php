...
<div class="col-lg-12 col-md-12">
    ...
    <tbody>
        <?php 
            ...
            $get_fmr_notification = "select * from fmr_notifications";
            $run_fmr_notification = mysqli_query($con,$get_fmr_notification);
            $counter = 0;
            while($row_fmr_notification = mysqli_fetch_array($run_fmr_notification)){
            
            $counter = ++$counter;
            $fmr_notification_id = $row_fmr_notification['fmr_notification_id'];
            $fmr_id = $row_fmr_notification['fmr_id'];
            $notification_subject = $row_fmr_notification['notification_subject'];
            $notification_content = $row_fmr_notification['notification_content'];
            $updated_date = $row_fmr_notification['updated_date'];
