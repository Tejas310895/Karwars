...
<form action="order.php" class="add_form" method="post" id="order_submit">
    ...
    <div class="container-fluid px-0 pro_cart bg-light">
        <!-- Delivery Address -->
        <div class="row pt-2 px-3 bg-white <?php if (empty($_COOKIE['user']) || $C_count <= 0) {
                                                echo "d-none";
                                            } ?>">
            <div class="col-6">
        ...
        <input type="hidden" name="c_id" class="form-control" value="<?php if (!empty($_COOKIE['user'])) {
                                                                            echo $customer_id;
                                                                        } ?>">
        <div class="row <?php if (empty($_COOKIE['user']) || $C_count <= 0) {
                            echo "d-none";
                        } ?>">
            <div class="col-12">
        ...
        <!-- Order Schedule Date -->
        <!-- Promo Section -->
        <div class="row bg-white <?php if (isset($_COOKIE['promo']) || !isset($_COOKIE['user']) || $C_count <= 0) {
                                        echo "d-none";
                                    } ?>">
            <div class="col-8">
                <div class="row">
        ...
        <div class="row bg-white <?php if (!isset($_COOKIE['promo']) || !isset($_COOKIE['user'])) {
                                        echo "d-none";
                                    } ?>">
        ...
        ?>
        <!-- Billing Section -->
        <div class="row bg-white mt-2 px-4 py-2 text-dark <?php if ($cart_count < 1) {
                                                                echo "d-none";
                                                            } else {
                                                                echo "show";
                                                            } ?>">
            ...
            <div class="col-6 pull-left <?php if ($total >= 499) {
                                            echo "d-none";
                                        } else {
                                            echo "show";
                                        } ?>">
            ...
            <div class="col-6 pull-right <?php if ($total >= 499) {
                                                echo "d-none";
                                            } else {
                                                echo "show";
                                            } ?>">
            ...
            ?>
                ...
                <div class="col-3 pull-right text-success">
                    <h5 class="cou-text mb-0 text-right"><?php if (isset($dis_amt)) {
                                                                echo $dis_amt;
                                                            } ?></h5>
                    <input type="hidden" name="coupon_id" value="<?php echo $coupon_dis_id; ?>">
                </div>
                <div class="col-12">
                    <small class="text-center text-success <?php if ($dis_coupon_type === 'product') {
                                                                echo 'show';
                                                            } else {
                                                                echo 'd-none';
                                                            } ?>" style="margin-top:10px;">Get the offer product in order</small>
                </div>
            <?php } else {
                $grand_total = ($total + $add_del);
            } ?>
            <div class="col-6 pull-left">
            ...
            <div class="col-12 <?php if ($total >= 499) {
                                    echo "d-none";
                                } else {
                                    echo "show";
                                } ?>">
        ...
        <div class="container-fluid mt-2 <?php if ($cart_count < 1) {
                                                echo "d-none";
                                            } else {
                                                echo "show";
                                            } ?>">
    ...
    <div class="container mt-5" style="display:<?php if ($count > 0) {
                                                    echo "none";
                                                } else {
                                                    echo "block";
                                                } ?>;">
        <div class="row">
            ...
            <div class="col-lg">
                <h5 class="order_again">We are waiting for your order</h5>
            </div>
        ...
        <table class="table table-sm table-borderless bill_section ">
            <tbody>
                ...
                <tr>
                    ...
                    <td class="bill_sub_total text-center">₹ <?php //echo $total; 
                                                                ?></td>
                </tr>
                <tr style="display:<?php //if($del_charges>0){echo"table-row";}else{echo"none";} 
                                    ?>;">
                    <th scope="row" class="bill_charges" >Delivery Charges:</th>
                    <td class="bill_charges text-center">₹ <? php // echo $del_charges; 
                                                            ?></td>
                </tr>
                <tr>
                    <th scope="row" class="bill_total">TOTAL:</th>
                    <td class="bill_total text-center">₹ <? php // echo $total+$del_charges; 
                                                            ?></td>
                </tr>
            </tbody>
        </table>
        <h5 class="save_total text-center <?php //if($save_total>0){echo "show";}else{echo "d-none";} 
                                            ?>" >You saved ₹<?php //echo $you_save; 
                                                                                                                        ?> on this order</h5>
    </div> -->
    ...
    <!-- checkout float -->
    <div class="container-fluid px-0 fixed-bottom " style="display:<?php if ($count > 0) {
                                                                        echo "block";
                                                                    } else {
                                                                        echo "none";
                                                                    } ?>;">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer" style="border-top:0;">
                    <button type="submit" class="btn btn-success btn-block">
                        <h5 class="mb-0" style="font-family: Josefin Sans;">Place Order</h5>
                    </button>
                </div>
            </div>
        </div>
